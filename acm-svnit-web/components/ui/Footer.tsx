...
const footerSections = [
  ...
  },
  {
    title: "Connect",
    links: [
      { label: "GitHub", href: "https://github.com/acmsvnit" },
      { label: "LinkedIn", href: "https://linkedin.com/company/acmsvnit" },
      { label: "Twitter/X", href: "https://twitter.com/acmsvnit" },
      { label: "Discord", href: "#" },
    ],
  },
];
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 py-12 lg:py-16">
          ...
          <div className="col-span-2 md:col-span-1">
            ...
            <p className="text-sm text-white/60 leading-relaxed max-w-xs">
              The SVNIT Chapter of the Association for Computing Machinery.
            ...
            <div className="flex gap-3 mt-6">
              {socialIcons.map((social) => (
                <a
                  ...
                  className="flex h-10 w-10 items-center justify-center rounded-full border-2 border-white/20 text-white/60 hover:text-white hover:border-white/50 hover:bg-white/10 transition-all"
                >
                  <social.Icon size={16} />
                </a>
              ))}
