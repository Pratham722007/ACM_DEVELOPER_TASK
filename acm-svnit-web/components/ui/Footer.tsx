            ...
            <div className="flex gap-3 mt-6">
              {socialIcons.map((social) => (
                <a
                  ...
                  className="flex h-9 w-9 items-center justify-center rounded-lg border border-border text-muted hover:text-foreground hover:border-border-hover transition-all"
                >
                  <social.Icon size={16} />
                </a>
              ))}
